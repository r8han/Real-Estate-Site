...
const Footer = () => {
  return (
    <Box backgroundColor="blue.600">
      ...
      <Box display="flex" backgroundColor="blue.900" padding="2rem" justifyContent="center" alignItems="center" flexDirection="column" color="white">
        <Box display="flex" gap="2" alignItems="center">
          <HiHomeModern />
          <Text fontSize="lg" fontWeight="black">BRICKS</Text>
        </Box>
        <Text marginTop="1rem" fontSize="xs" textAlign="center">All rights reserved - Copyright BRICKS</Text>
      </Box>
    </Box>
  );
};
